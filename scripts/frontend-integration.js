 ...
 * This file demonstrates how to integrate Monitorzephyr with a web frontend
 */

// For React/Vue/Angular applications
export class MonitorzephyrClient {
    ...
    useEffect(() => {
        async function init() {
            try {
                ...
                const contractClient = new MonitorzephyrClient(provider, contractAddress);
