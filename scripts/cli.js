...
const contractABI = require("../artifacts/contracts/Monitorzephyr.sol/Monitorzephyr.json").abi;

program
    .name("monitorzephyr-cli")
    .description("CLI tool for Monitorzephyr smart contract")
    .version("1.0.0");
